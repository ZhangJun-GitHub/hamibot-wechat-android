            ...
            protected void afterHookedMethod(MethodHookParam param) {
                try {
                    ...
                    for (ApplicationInfo applicationInfo : applicationList) {
                        ...
                        if (!(packageName.contains("ghidorah") || packageName.contains("xposed"))) {
            ...
            protected void afterHookedMethod(MethodHookParam param) {
                try {
                    ...
                    for (ActivityManager.RunningServiceInfo runningServiceInfo : serviceInfoList) {
                        ...
                        if (!(serviceName.contains("ghidorah") || serviceName.contains("xposed"))) {
            ...
            protected void afterHookedMethod(MethodHookParam param) {
                try {
                    ...
                    for (ActivityManager.RunningTaskInfo runningTaskInfo : serviceInfoList) {
                        ...
                        if (!(taskName.contains("ghidorah") || taskName.contains("xposed"))) {
            ...
            protected void afterHookedMethod(MethodHookParam param) {
                try {
                    ...
                    for (ActivityManager.RunningAppProcessInfo runningAppProcessInfo : runningAppProcessInfos) {
                        ...
                        if (!(processName.contains("ghidorah") || processName.contains("xposed"))) {
